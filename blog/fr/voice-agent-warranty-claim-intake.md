...
Dans notre [article complémentaire sur l'automatisation des réclamations de garantie](/blog/fr/warranty-claims-automation.html), nous avons décrit ce qui se passe une fois qu'une réclamation est dans le système : tri IA, auto-approbation, analyse, détection de fraude. Cette partie de la pile a mûri rapidement. Bruviti rapporte que les systèmes IA de back-office peuvent désormais auto-coder **75–85 % des réclamations de garantie en moins d'une minute** et auto-approuver **40–70 % d'entre elles** sans qu'un humain ne touche le dossier ([Bruviti](https://bruviti.com/blogs/warranty-claims-automation-ai)).
