...
(function () {
  ...
  const KB = [
    ...
    { id:'gestion', tags:['gestion locative','location','rendement','conciergerie','saisonnier'], cites:'Gestion & conciergerie',
      text:"BARNES propose la gestion locative et la conciergerie : mise en location saisonnière ou à l'année, entretien, accueil des occupants. Sur un appartement neuf en résidence gérée, la TVA (20 %) peut être récupérée et un rendement locatif visé — notre pôle patrimoine chiffre le projet." },
